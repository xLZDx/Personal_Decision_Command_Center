...
| G1   | Repository + governance enforcement + CI + contracts                                                                                                                                                                          | **HOLD — implementation exists (`b784265`) but is NOT gate-approved.** GPT-PM: REJECT as a gate (G1-B1 no authorized gate, G1-B2 remote CI red, G1-M1/M2/M3). Remediation: `../governance/plans/G1_REMEDIATION_PLAN.md` |
